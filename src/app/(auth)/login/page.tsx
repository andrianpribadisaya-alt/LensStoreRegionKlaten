      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <div className="bg-[#0d1526] border border-white/8 rounded-2xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-xl font-medium text-slate-100">Selamat datang</h1>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-2.5 bg-white/5 border border-white/10 rounded-xl text-sm text-slate-200 placeholder-slate-600 focus:outline-none focus:border-sky-500/50 focus:bg-white/8 transition"
              />
            </div>
